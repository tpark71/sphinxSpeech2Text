...
class FsgModel(object):
    ...
    def null_trans_add(self, src, dst, logp):
        r"""null_trans_add(FsgModel self, int32 src, int32 dst, int32 logp) -> int32"""
        return _sphinxbase.FsgModel_null_trans_add(self, src, dst, logp)

    def tag_trans_add(self, src, dst, logp, wid):
        r"""tag_trans_add(FsgModel self, int32 src, int32 dst, int32 logp, int32 wid) -> int32"""
        return _sphinxbase.FsgModel_tag_trans_add(self, src, dst, logp, wid)

    def add_silence(self, silword, state, silprob):
        r"""add_silence(FsgModel self, char const * silword, int32 state, float silprob) -> int"""
...
class JsgfRule(object):
    ...
    @staticmethod
    def fromIter(itor):
        r"""fromIter(jsgf_rule_iter_t * itor) -> JsgfRule"""
        return _sphinxbase.JsgfRule_fromIter(itor)

    def name(self):
        r"""name(JsgfRule self) -> char const *"""
        return _sphinxbase.JsgfRule_name(self)

    def public(self):
        r"""public(JsgfRule self) -> bool"""
...
def JsgfRule_fromIter(itor):
    r"""JsgfRule_fromIter(jsgf_rule_iter_t * itor) -> JsgfRule"""
    return _sphinxbase.JsgfRule_fromIter(itor)
...
class NGramModel(object):
    ...
    @staticmethod
    def fromIter(itor):
        r"""fromIter(ngram_model_set_iter_t * itor) -> NGramModel"""
    ...
    def write(self, path, ftype):
        r"""write(NGramModel self, char const * path, ngram_file_type_t ftype)"""
        return _sphinxbase.NGramModel_write(self, path, ftype)

    def str_to_type(self, str):
        r"""str_to_type(NGramModel self, char const * str) -> ngram_file_type_t"""
    ...
    def size(self):
        r"""size(NGramModel self) -> int32"""
        return _sphinxbase.NGramModel_size(self)

    def add_word(self, word, weight):
        r"""add_word(NGramModel self, char const * word, float32 weight) -> int32"""
        return _sphinxbase.NGramModel_add_word(self, word, weight)

    def add_class(self, c, w, n, weights):
        r"""add_class(NGramModel self, char const * c, float32 w, size_t n, float32 const * weights) -> int32"""
        return _sphinxbase.NGramModel_add_class(self, c, w, n, weights)

    def prob(self, n):
        r"""prob(NGramModel self, size_t n) -> int32"""
...
def NGramModel_fromIter(itor):
    r"""NGramModel_fromIter(ngram_model_set_iter_t * itor) -> NGramModel"""
    return _sphinxbase.NGramModel_fromIter(itor)
...
class LogMath(object):
    ...
    def exp(self, prob):
        r"""exp(LogMath self, int prob) -> float64"""
...
class NGramModelSetIterator(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ptr = property(_sphinxbase.NGramModelSetIterator_ptr_get, _sphinxbase.NGramModelSetIterator_ptr_set, doc=r"""ptr : p.ngram_model_set_iter_t""")

    def __init__(self, ptr):
        r"""__init__(NGramModelSetIterator self, ngram_model_set_iter_t * ptr) -> NGramModelSetIterator"""
...
class JsgfIterator(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ptr = property(_sphinxbase.JsgfIterator_ptr_get, _sphinxbase.JsgfIterator_ptr_set, doc=r"""ptr : p.jsgf_rule_iter_t""")

    def __init__(self, ptr):
        r"""__init__(JsgfIterator self, jsgf_rule_iter_t * ptr) -> JsgfIterator"""
...
class NGramModelSet(object):
    ...
    def count(self):
        r"""count(NGramModelSet self) -> int32"""
